...
export default async function StudentHBCPage({ searchParams }: { searchParams: Promise<{ new?: string }> }) {
 ...
 <div>
 <h2 style={{ fontSize: 22, fontWeight: 700, color: "#1C2620", fontFamily: "inherit", margin: 0 }}>SBP Generator</h2>
 <p style={{ fontSize: 12, color: "#6E7A6C", marginTop: 4 }}>School-Based Projects — 6-stage ZIMSEC workflow with AI guidance, for any subject</p>
 </div>

 <HBCNewProjectForm profileId={profile.id} defaultOpen={openNew === "1"} />

 {(projects ?? []).length === 0 ? (
 <div style={{ background: "rgba(28,38,32,0.02)", border: "1px solid rgba(28,38,32,0.06)", borderRadius: 16, padding: "48px 24px", textAlign: "center" }}>
 <div style={{ fontSize: 40, marginBottom: 12 }}></div>
 <p style={{ fontSize: 15, fontWeight: 600, color: "#566257", fontFamily: "inherit", marginBottom: 6 }}>No projects yet</p>
 <p style={{ fontSize: 13, color: "#6E7A6C" }}>Start your first School-Based Project above.</p>
 </div>
 ) : (
