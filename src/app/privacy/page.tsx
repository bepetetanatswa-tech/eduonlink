...
export const metadata: Metadata = {
  title: "Privacy Policy — Educonnect",
};
    ...
    <div className="min-h-screen py-16 px-6" style={{ background: "#07080C" }}>
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-xs mb-10" style={{ color: "#2A2D3E" }}>
          Educonnect is a product of <strong style={{ color: "#4A5170" }}>Vavhimi Threads (Pvt) Ltd</strong>, a registered company in Zimbabwe.
        </p>
        ...
        <div className="flex flex-col gap-8" style={{ color: "#8892B0" }}>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              We use your information to provide and improve the Educonnect platform, personalise your learning experience, send you account and service notifications, and comply with legal obligations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              Educonnect serves students of all ages. For users under 13, we require parental consent. Parents and guardians can request deletion of their child&apos;s data at any time by contacting us.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              We do not sell your personal information. We may share information with your school administrator if you are a student at a Educonnect-enrolled institution, or with third-party service providers who assist in operating the platform.
            </p>
          </section>
