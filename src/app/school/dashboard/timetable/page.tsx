...
export default async function SchoolTimetablePage() {
  ...
  if (!member?.school_id) return <p style={{ color: "#6E7A6C", padding: 24 }}>No school linked to your account.</p>;
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h2 style={{ fontSize: 20, fontWeight: 700, color: "#1C2620", fontFamily: "inherit", margin: 0 }}>Timetable</h2>
        <p style={{ fontSize: 12, color: "#6E7A6C", marginTop: 4 }}>Build and manage the school timetable — click any slot to assign a lesson</p>
      </div>
