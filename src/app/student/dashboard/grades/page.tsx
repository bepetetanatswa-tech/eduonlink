...
export default async function StudentGradesPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h2 style={{ fontSize: 20, fontWeight: 700, color: "#1C2620", fontFamily: "inherit", margin: 0 }}>My Grades</h2>
        <p style={{ fontSize: 12, color: "#6E7A6C", marginTop: 4 }}>View your academic performance and teacher feedback</p>
      </div>
