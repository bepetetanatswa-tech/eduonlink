...
export default function OnboardingPage() {
 ...
 <p style={{ color: "#6E7A6C", fontSize: 14 }}>Loading your profile…</p>
 </div>
 );
 }
 ...
 style={{ width: i === step ? 24 : 8, height: 8, background: i <= step ? "#B1502B" : "rgba(28,38,32,0.1)" }}
 />
 ))}
 </div>
 ...
 <p className="text-sm max-w-sm mx-auto" style={{ color: "#566257" }}>{meta.subtitle}</p>
 </div>
 ...
 style={{ background: "rgba(11,12,19,0.8)", border: "1px solid rgba(28,38,32,0.07)", backdropFilter: "blur(20px)" }}
 >
 {currentKey === "welcome" && (
 <div className="text-center py-4" style={{ color: "#566257", fontSize: 14, lineHeight: 1.7 }}>
 ...
 <label className="text-sm font-medium" style={{ color: "#566257" }}>Short bio (optional)</label>
 <textarea
 rows={3}
 value={bio}
 ...
 <div>
 <p className="text-sm font-medium mb-2" style={{ color: "#566257" }}>Linked children</p>
 {children.length === 0 && <p className="text-xs mb-3" style={{ color: "#6E7A6C" }}>No children linked yet.</p>}
 ...
 {linkError && <p className="text-xs mb-2" style={{ color: "#A3311E" }}>{linkError}</p>}
 ...
 style={{ background: "rgba(169,135,63,0.06)", border: "1px solid rgba(169,135,63,0.15)", color: "#566257" }}
 >
 ...
 <p className="text-sm font-medium" style={{ color: "#566257" }}>Choose a plan</p>
 <div className="flex flex-col gap-2">
 {schoolPlans.map((p) => {
 ...
 style={{
 background: active ? "rgba(167,139,250,0.12)" : "rgba(28,38,32,0.03)",
 border: `1px solid ${active ? "rgba(167,139,250,0.4)" : "rgba(28,38,32,0.07)"}`,
 }}
 >
 <div>
 <p className="text-sm font-semibold" style={{ color: active ? "#C4B5FD" : "#1C2620" }}>{p.name}</p>
 <p className="text-xs" style={{ color: "#6E7A6C" }}>{p.features[0]}{p.features[1] ? ` · ${p.features[1]}` : ""}</p>
 </div>
 <p className="text-sm font-bold" style={{ color: active ? "#C4B5FD" : "#566257" }}>{p.price === 0 ? "Free" : `$${p.price.toFixed(2)}/mo`}</p>
 </button>
 );
 })}
 </div>
 <p className="text-xs" style={{ color: "#6E7A6C" }}>You can change plans anytime from your subscription page. Payment is verified after your school is approved.</p>
 </>
 )}

 {currentKey === "done" && (
 <div className="text-center py-4">
 <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 bg-edu-bottle-100 border border-edu-bottle-200 text-edu-bottle">
                  <IconCheck size={22} strokeWidth={2.4} />
                </div>
 <p style={{ color: "#566257", fontSize: 14 }}>
