    ...
    <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
      <div
        ...
        style={{
          ...
          background: preview ? "transparent" : "linear-gradient(135deg, #A78BFA, #7C5CE0)",
      ...
      <div>
        <button
          ...
          disabled={uploading}
          style={{
            fontSize: 13, fontWeight: 600, color: "#A78BFA", background: "rgba(167,139,250,0.1)",
            border: "1px solid rgba(167,139,250,0.25)", borderRadius: 10, padding: "8px 14px", cursor: "pointer",
          }}
        >
