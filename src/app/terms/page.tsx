...
export default function TermsPage() {
  return (
    <div className="min-h-screen py-16 px-6" style={{ background: "#F2EEE3" }}>
      <div className="max-w-2xl mx-auto">
        <Link href="/" className="text-sm mb-10 inline-block transition-colors" style={{ color: "#B1502B" }}>
          ← Back to EduOnLink
        </Link>

        <h1 className="font-display font-bold text-edu-ink text-3xl mb-2">Terms of Service</h1>
        <p className="text-sm mb-1" style={{ color: "#6E7A6C" }}>Last updated: July 2026</p>
        <p className="text-xs mb-10" style={{ color: "#8D9689" }}>
          EduOnLink is operated by <strong style={{ color: "#6E7A6C" }}>Vavhimi Threads (Pvt) Ltd</strong>, a registered company in Zimbabwe.
        </p>

        <div className="flex flex-col gap-8" style={{ color: "#566257" }}>
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">2. Use of the Platform</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">3. Accounts</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">4. Content</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">5. Privacy</h2>
            <p className="text-sm leading-relaxed">
              Your use of EduOnLink is also governed by our{" "}
              <Link href="/privacy" style={{ color: "#B1502B" }}>Privacy Policy</Link>
              , which is incorporated into these Terms by reference.
            </p>
          </section>

          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">6. Paid Lessons, Courses & Platform Commission</h2>
            <p className="text-sm leading-relaxed mb-3">
              Teachers and schools may offer paid lessons and courses through EduOnLink. On every paid sale, EduOnLink retains a platform commission of <strong style={{ color: "#1C2620" }}>20% of the sale amount</strong>, and the teacher or school keeps the remaining 80%.
            </p>
            <p className="text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">7. Changes to Terms</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">8. Contact</h2>
            <p className="text-sm leading-relaxed">
              For questions about these Terms, contact us at{" "}
              <a href="mailto:vavhimiacademy@gmail.com" style={{ color: "#B1502B" }}>vavhimiacademy@gmail.com</a>.
            </p>
          </section>
        </div>
      </div>
