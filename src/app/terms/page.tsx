    ...
    <div className="min-h-screen py-16 px-6" style={{ background: "#07080C" }}>
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-xs mb-10" style={{ color: "#2A2D3E" }}>
          Vavhimi Online Academy (VOA) is operated by <strong style={{ color: "#4A5170" }}>Vavhimi Threads (Pvt) Ltd</strong>, a registered company in Zimbabwe.
        </p>
        ...
        <div className="flex flex-col gap-8" style={{ color: "#8892B0" }}>
          <section>
            ...
            <p className="text-sm leading-relaxed">
              By accessing or using Vavhimi Online Academy (&quot;VOA&quot;), you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              VOA is an educational platform designed for students, teachers, parents, and school administrators in Zimbabwe. You agree to use the platform only for lawful educational purposes and in accordance with these terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              VOA provides AI-generated educational content aligned with the ZIMSEC curriculum. Content is provided for educational purposes only and does not constitute official ZIMSEC materials.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              Your use of VOA is also governed by our{" "}
