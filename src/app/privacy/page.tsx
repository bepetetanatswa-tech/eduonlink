  ...
  return (
    <div className="min-h-screen py-16 px-6" style={{ background: "#1F4738" }}>
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="font-display font-bold text-3xl mb-2" style={{ color: "#F2EEE3" }}>Privacy Policy</h1>
        <p className="text-sm mb-1" style={{ color: "#AEB5A6" }}>Last updated: June 2026</p>
        <p className="text-xs mb-10" style={{ color: "#8D9689" }}>
          EduOnLink is a product of <strong style={{ color: "#AEB5A6" }}>Vavhimi Threads (Pvt) Ltd</strong>, a registered company in Zimbabwe.
        </p>

        <div className="flex flex-col gap-8" style={{ color: "#C7CDC0" }}>
          <section>
            <h2 className="font-display font-semibold text-lg mb-3" style={{ color: "#F2EEE3" }}>1. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-lg mb-3" style={{ color: "#F2EEE3" }}>2. How We Use Your Information</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-lg mb-3" style={{ color: "#F2EEE3" }}>3. Data Storage</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-lg mb-3" style={{ color: "#F2EEE3" }}>4. Children&apos;s Privacy</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-lg mb-3" style={{ color: "#F2EEE3" }}>5. Sharing of Information</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-lg mb-3" style={{ color: "#F2EEE3" }}>6. Your Rights</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-lg mb-3" style={{ color: "#F2EEE3" }}>7. Changes to This Policy</h2>
            <p className="text-sm leading-relaxed">
