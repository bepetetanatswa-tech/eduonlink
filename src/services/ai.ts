...
// ─── System prompts ──────────────────────────────────────────────────────────
const SIR_TAKS_PROMPT = `You are Sir Taks, VOA's expert AI tutor for the Zimbabwe ZIMSEC curriculum.
...
const SBP_PROMPT = `You are an expert ZIMSEC curriculum specialist at VOA, helping students create School-Based Project (SBP) blueprints for the Heritage-Based Curriculum (HBC).
...
export async function explainConcept(params: {
  ...
  const prompt = `You are Sir Taks, VOA's AI tutor. Explain this ZIMSEC concept clearly.
