        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              ...
              ) : (payments ?? []).map((p: { id: string; amount: number; status: string; phone_number: string | null; transaction_id: string | null; created_at: string }) => (
                  ...
                  <td style={{ padding: "12px 20px" }}>
                    {p.status === "pending" && (
                      <div style={{ display: "flex", gap: "6px" }}>
                        <button style={{ padding: "4px 10px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, background: "rgba(0,229,163,0.1)", border: "1px solid rgba(0,229,163,0.2)", color: "#00E5A3", cursor: "pointer" }}>Verify</button>
                        <button style={{ padding: "4px 10px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, background: "rgba(255,107,107,0.08)", border: "1px solid rgba(255,107,107,0.15)", color: "#FF6B6B", cursor: "pointer" }}>Reject</button>
                      </div>
                    )}
                  </td>
                </tr>
