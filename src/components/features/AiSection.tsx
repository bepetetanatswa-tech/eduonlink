...
function TypedText({ text, speed = 18 }: { text: string; speed?: number }) {
  ...
  return (
    <span>
      {displayed}
      {!done && <span className="inline-block w-0.5 h-4 align-middle ml-0.5 animate-pulse" style={{ background: "#00E5A3" }} />}
    </span>
  );
}
      ...
      <div className="container-voa">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            >
              <p className="font-mono text-xs font-medium tracking-[0.15em] uppercase mb-4" style={{ color: "#00E5A3" }}>
              ...
              <p className="text-base leading-relaxed mb-8" style={{ color: "#6B7290" }}>
                ...
                {[
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs mt-0.5" style={{ color: "#4A5170" }}>{c.sub}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <motion.button
                ...
                style={{ background: "linear-gradient(135deg, #00D496, #00E5A3)" }}
              >
                Try Sir Taks Free →
              </motion.button>
            </motion.div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="mx-auto font-mono text-xs" style={{ color: "#4A5170" }}>
                  sir-taks · voa
                </span>
              ...
              >
                {DEMO_PAIRS.map((p, i) => (
                  <button
                    ...
                    style={{
                      color: active === i ? "#90ABFF" : "#4A5170",
                      background: active === i ? "rgba(77,127,255,0.1)" : "transparent",
                      border: `1px solid ${active === i ? "rgba(77,127,255,0.2)" : "transparent"}`,
                    }}
                  >
                    <span className="font-mono text-[10px] mr-2" style={{ color: "#4D7FFF" }}>›</span>
                    {p.q}
                  </button>
                ))}
              </div>
              ...
              <div className="p-5 min-h-[200px]">
                ...
                <div className="flex justify-end mb-4">
                  <div
                    ...
                    style={{ background: "rgba(77,127,255,0.12)", color: "#90ABFF", border: "1px solid rgba(77,127,255,0.2)" }}
                  >
                    {DEMO_PAIRS[active].q}
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <div
                    ...
                    style={{ background: "rgba(0,229,163,0.15)", border: "1px solid rgba(0,229,163,0.3)" }}
                  >
                    ✦
                  </div>
                  <div>
                    <p className="text-[10px] font-mono font-semibold mb-2" style={{ color: "#00E5A3" }}>Sir Taks</p>
              ...
              >
                <div
                  ...
                  style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", color: "#4A5170" }}
                >
                ...
                <button
                  ...
                  style={{ background: "rgba(0,229,163,0.15)", border: "1px solid rgba(0,229,163,0.3)" }}
                >
                  <svg className="w-4 h-4" fill="none" stroke="#00E5A3" viewBox="0 0 24 24">
