  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-20">
        <p style={{ color: "#4A5170", fontSize: 14 }}>Loading…</p>
      </div>
    );
  }
    ...
    <div className="flex justify-center py-10 px-4">
      <div className="w-full max-w-lg">
        <div
          ...
          style={{ background: "rgba(11,12,19,0.8)", border: "1px solid rgba(255,255,255,0.07)" }}
        >
          <div className="text-center">
            <div className="text-4xl mb-3">{rejected ? "⚠️" : "📋"}</div>
          ...
          {done && (
            <div
              ...
              style={{ background: "rgba(0,229,163,0.06)", border: "1px solid rgba(0,229,163,0.2)", color: "#00E5A3" }}
            >
