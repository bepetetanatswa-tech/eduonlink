...
const COLORS = ["#B1502B", "#1F4738", "#A9873F", "#A3311E", "#A9873F", "#FF9B6B", "#00B4D8", "#50FA7B"];
...
export function TimetableGrid({ schoolId, classId, teacherId }: { schoolId?: string; classId?: string; teacherId?: string }) {
 ...
 <div style={{ background: "rgba(28,38,32,0.02)", border: `1px solid ${S.border}`, borderRadius: 14, padding: "48px 24px", textAlign: "center" }}>
 ...
 <div />
 {DAYS.map(d => (
 <div key={d} style={{ padding: "10px 12px", background: "rgba(177,80,43,0.08)", border: "1px solid rgba(177,80,43,0.15)", borderRadius: 10, textAlign: "center" }}>
 ...
 <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "rgba(28,38,32,0.02)", border: `1px solid ${S.border}`, borderRadius: 10, padding: "8px 4px" }}>
 ...
 background: slot ? `${color}0D` : "rgba(28,38,32,0.01)",
 ...
 <p style={{ fontSize: 11, color: "rgba(28,38,32,0.06)", textAlign: "center" }}>—</p>
 )}
 </div>
 );
 })}
