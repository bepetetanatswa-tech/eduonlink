  ...
  return (
    <div className="min-h-screen py-16 px-6" style={{ background: "#F2EEE3" }}>
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="font-display font-bold text-edu-ink text-3xl mb-2">Privacy Policy</h1>
        <p className="text-sm mb-1" style={{ color: "#6E7A6C" }}>Last updated: June 2026</p>
        <p className="text-xs mb-10" style={{ color: "#8D9689" }}>
          EduOnLink is a product of <strong style={{ color: "#6E7A6C" }}>Vavhimi Threads (Pvt) Ltd</strong>, a registered company in Zimbabwe.
        </p>

        <div className="flex flex-col gap-8" style={{ color: "#566257" }}>
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">2. How We Use Your Information</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">3. Data Storage</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">4. Children&apos;s Privacy</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">5. Sharing of Information</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">6. Your Rights</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display font-semibold text-edu-ink text-lg mb-3">7. Changes to This Policy</h2>
            <p className="text-sm leading-relaxed">
