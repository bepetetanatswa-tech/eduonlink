  ...
  super_admin: [
    {
      ...
      items: [
        ...
        { label: "SBP Generator", href: "/admin/dashboard/hbc",         icon: ic("M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z") },
        ...
        { label: "Exam Prep",    href: "/admin/dashboard/exam-prep",   icon: ic("M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z") },
        { label: "Digital Library", href: "/admin/dashboard/library",  icon: ic("M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253") },
    ...
    },
    {
      group: "Class Tools",
      items: [
        { label: "Assignments", href: "/admin/dashboard/assignments", icon: ic("M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01") },
        { label: "Attendance",  href: "/admin/dashboard/attendance",  icon: ic("M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4") },
        { label: "Grade Book",  href: "/admin/dashboard/grades",      icon: ic("M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z") },
        { label: "Timetable",   href: "/admin/dashboard/timetable",   icon: ic("M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z") },
      ],
    },
    {
      group: "Operations",
      items: [
        ...
        { label: "EduChat",     href: "/admin/dashboard/messages",    icon: ic("M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z") },
  ...
  school_admin: [
    {
      ...
      items: [
        ...
        { label: "EduChat",       href: "/school/dashboard/messages",      icon: ic("M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z") },
  ...
  teacher: [
    {
      ...
      items: [
        ...
        { label: "Exam Prep",    href: "/teacher/dashboard/exam-prep",  icon: ic("M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z") },
        { label: "SBP Generator", href: "/teacher/dashboard/hbc",          icon: ic("M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z") },
    ...
    },
    {
      group: "Communication",
      items: [
        { label: "EduChat",       href: "/teacher/dashboard/messages",       icon: ic("M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z") },
  ...
  student: [
    {
      ...
      items: [
        ...
        { label: "Lessons & Courses", href: "/student/dashboard/lessons",    icon: ic("M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253") },
        ...
        { label: "SBP Generator", href: "/student/dashboard/hbc",          icon: ic("M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z") },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "EduChat",     href: "/student/dashboard/messages",   icon: ic("M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z") },
  ...
  parent: [
    {
      ...
      items: [
        ...
        { label: "EduChat",     href: "/parent/dashboard/messages",      icon: ic("M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z") },
