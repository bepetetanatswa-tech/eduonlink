    ...
    <div className="min-h-screen p-8" style={{ background: "#07080C" }}>
      <div className="max-w-5xl mx-auto">
        <h1 className="font-display font-bold text-white text-3xl mb-2">
          Teacher Dashboard — {profile?.first_name ?? "Teacher"} 👨‍🏫
        </h1>
        <p className="text-sm mb-8" style={{ color: "#6B7290" }}>
          Lesson builder · Student tracking · Live classes
        </p>
        <div
        ...
        >
          ...
          <h2 className="font-display font-semibold text-white text-xl mb-2">Teacher dashboard coming soon</h2>
          <p className="text-sm" style={{ color: "#6B7290" }}>
            Lesson builder, student analytics, and AI-assisted marking will be here.
          </p>
        </div>
      </div>
    </div>
