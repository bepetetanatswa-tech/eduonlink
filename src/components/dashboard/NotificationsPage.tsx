...
export function NotificationsPage({ profileId }: { profileId: string }) {
 ...
 <h1 style={{ fontSize: 20, fontWeight: 700, color: S.text, fontFamily: "inherit", margin: 0 }}>Notifications</h1>
 ...
 <button onClick={clearAll} style={{ fontSize: 12, color: "#A3311E", background: "none", border: "none", cursor: "pointer" }}>Clear all</button>
 )}
 <button
 ...
 style={{ width: 34, height: 18, borderRadius: 10, background: enabled ? "rgba(31,71,56,0.2)" : "rgba(28,38,32,0.06)", border: `1px solid ${enabled ? "#1F4738" : "rgba(28,38,32,0.1)"}`, cursor: "pointer", position: "relative", flexShrink: 0 }}
 >
 <div style={{ position: "absolute", top: 1, left: enabled ? 17 : 1, width: 14, height: 14, borderRadius: "50%", background: enabled ? "#1F4738" : "#566257", transition: "left 0.15s" }} />
 </button>
 </div>
 );
 })}
 ...
 background: tab === t ? S.accent : "rgba(28,38,32,0.04)",
