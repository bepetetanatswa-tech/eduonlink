    ...
    <div className="min-h-screen p-8" style={{ background: "#07080C" }}>
      <div className="max-w-5xl mx-auto">
        <h1 className="font-display font-bold text-white text-3xl mb-2">
          School Admin — {profile?.school_name ?? "School"} 🏫
        </h1>
        <p className="text-sm mb-8" style={{ color: "#6B7290" }}>
          Manage teachers, students, and institution-wide VOA access
        </p>
        <div
        ...
        >
          ...
          <h2 className="font-display font-semibold text-white text-xl mb-2">School admin panel coming soon</h2>
          <p className="text-sm" style={{ color: "#6B7290" }}>
            Bulk enrollment, teacher management, school analytics, and institution-wide reporting will be here.
          </p>
        </div>
      </div>
    </div>
